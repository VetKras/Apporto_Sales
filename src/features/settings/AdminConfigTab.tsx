    ...
    <div className="max-w-3xl space-y-6">
      ...
      {section === 'prices' && (
        <div className="space-y-6">
          <div>
            <h3 className="text-sm font-semibold text-neutral-900">CoTutor</h3>
            <p className="text-xs text-neutral-500 mt-0.5">Formula-driven — see Deals & Quotes for how these assumptions turn into a per-student price.</p>
          </div>
          ...
          {!cotutorAssumptions ? (
            ...
            <>
              ...
              <div className="card p-5 space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-semibold text-neutral-900">Approved AI Models</h4>
          ...
          <div className="border-t border-neutral-200 pt-6">
            <h3 className="text-sm font-semibold text-neutral-900">Flat-Rate Products</h3>
          </div>
